...
${BLUE}OPTIONS:${NC}
    -d, --dir DIRS         Directories to include (e.g., "@lib/ @test/")
...
${BLUE}EXAMPLES:${NC}
    ${YELLOW}# Analyze Kotlin source file${NC}
    $0 -d "@C:/Users/dasbl/AndroidStudioProjects/VitruvianRedux/app/src/" "How is BLE connection implemented in VitruvianBleManager.kt? Show code."

    ${YELLOW}# Trace a bug in Flutter code${NC}
    $0 -d "@lib/" "Error at workout_provider.dart:145. Trace root cause through call stack."

    ${YELLOW}# Architectural review of entire codebase${NC}
    $0 --all-files "Review Flutter architecture for security vulnerabilities. Output findings."

    ${YELLOW}# Verify port from Kotlin to Dart${NC}
    $0 "Compare these implementations and verify functionality is preserved:
    Kotlin: [path]
    Dart: [path]"

    ${YELLOW}# Analyze both Kotlin and Flutter projects${NC}
    $0 -d "@C:/Users/dasbl/AndroidStudioProjects/VitruvianRedux/app/src/ @lib/" "How does rep counting differ between Kotlin and Dart ports?"
...
${BLUE}PROMPT BEST PRACTICES:${NC}
    ✅ Be specific: "How is BLE implemented?" vs "How does this work?"
    ...
    ✅ For porting: "Analyze [Kotlin file]. Provide complete code with explanations for Dart translation."
